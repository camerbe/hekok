...
export class ArticleMetaService {
  ...
  : null;
    const titre=ArticleMetaService.getTitle(article.countries.pays,article.titre,article.countries.country,)+' - Hekok.org';
    ...
    this.meta.updateTag({ name: 'article:section', content: article.typearticles.typearticle });
  ...
  private updateOpenGraphTags(article:ArticleDetail){
    ...
    this.meta.updateTag({ name: 'og:image', content: article.image });
    this.meta.updateTag({ name: 'og:image:alt', content:  article.titre });
    this.meta.updateTag({ name: 'og:image:width', content: '850' });
    ...
    this.meta.updateTag({ name: 'og:site_name', content: 'hekok.org' });
